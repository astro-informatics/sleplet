...
for ell in range(2, 0, -1):
    ...
    f_sphere = s2fft.inverse(flm, f.L, Method="MWSS")
...
for ell in range(2, 0, -1):
    ...
    f_sphere = s2fft.inverse(flm_rot, f.L, Method="MWSS")
...
for ell in range(5):
    for m in range(ell + 1):
        ...
        f_sphere = s2fft.inverse(f.coefficients, f.L, Method="MWSS")
        sleplet.plotting.PlotSphere(
            f_sphere,
            f.L,
...
for a, b, g in [(0, 0, 0.25), (0, 0.25, 0.25), (0.25, 0.25, 0.25)]:
    ...
    g_sphere = s2fft.inverse(glm_rot, f.L, Method="MWSS")
    sleplet.plotting.PlotSphere(
        g_sphere,
        f.L,
...
g_sphere = s2fft.inverse(glm_trans, f.L, Method="MWSS")
